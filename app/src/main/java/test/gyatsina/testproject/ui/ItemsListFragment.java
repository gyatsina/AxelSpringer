...
import test.gyatsina.testproject.adapters.ImageItemsAdapter;
...
import test.gyatsina.testproject.repository.ImagesRequestManager;
...
public class ItemsListFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Repository<ShutterImage> flowerImagesRepository = TestApplication.from(getActivity()).getFlowerImagesRepository();
